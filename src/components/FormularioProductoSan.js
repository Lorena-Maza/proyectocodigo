...
import { subirImagen } from "../services/productosSanService";
import {storage} from '../config/firebase';
import Swal from "sweetalert2";

let imagenProducto;

export default function FormularioProductoSan({createProduct, textoBoton}) {
    ...
    <form onSubmit={(e) => {manejarSubmit(e)}} >
      <div className="form-group">
        <div  className="card-header">
          <h1 className="my-0 font-weight-normal">Producto</h1>
        </div>
      ...
      <div className="form-group">
        <label  htmlFor="producto_stock">Elegir Imagen</label>
        <input 
        type="file"
