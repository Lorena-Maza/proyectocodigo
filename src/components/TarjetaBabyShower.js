...
export default function TarjetaBabyShower({producto}) {
  ...
  return (
    ...
    <div style={{ width: "300px", display: "flex", alignItems: "center"}}>
      ...
      <div class="card-body">
        ...
        <button type="button" class="btn btn-lg btn-block btn-outline-primary" to={`/detalle/${producto.producto_id}`}>Detalle</button>
      </div>
      <br />
